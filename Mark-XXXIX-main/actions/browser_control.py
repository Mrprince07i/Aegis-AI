    ...
    async def _launch(self):
        ...
        if engine_name == "firefox":
            ...
            try:
                ...
                aegis = str(Path.home() / ".jarvis_profiles" / "firefox_jarvis")
                Path(aegis).mkdir(parents=True, exist_ok=True)
                self._context = await engine_obj.launch_persistent_context(aegis, **kwargs)
